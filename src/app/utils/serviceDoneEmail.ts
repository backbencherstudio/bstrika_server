  ...
  <div style="border: 1px solid #e0e0e0; border-radius: 10px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.05);">
    ...
    <div style="padding: 25px;">
      ...
      <p style="font-size: 15px; line-height: 1.6; margin-top: 15px;">
        Thank you for the trust and opportunity to work with you. Reviews help others make informed decisions, so if you have a moment, your feedback would mean a lot.
      </p>
